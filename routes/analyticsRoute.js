...
router.get(
  ...
  analyticsController.getCampaignSummary
);
router.get("/campaign/:campaignId/opens", analyticsController.getCampaignOpens);
router.get(
  "/campaign/:campaignId/clicks",
  analyticsController.getCampaignClicks
);
router.get(
  "/campaign/:campaignId/geo",
  analyticsController.getCampaignGeoAnalytics
);
router.get(
  "/campaign/:campaignId/devices",
  analyticsController.getCampaignDeviceAnalytics
);
router.get(
  "/campaign/:campaignId/timing",
  analyticsController.getCampaignTimingAnalytics
);
router.get(
  "/campaign/:campaignId/recipients",
  analyticsController.getCampaignRecipientAnalytics
);
router.get(
  "/campaign/:campaignId/links",
  analyticsController.getCampaignLinkAnalytics
);
router.get(
  "/campaign/:campaignId/bounces",
  analyticsController.getCampaignBounceAnalytics
);

// User-level analytics across campaigns
router.get("/user/summary", analyticsController.getUserSummary);
router.get(
  "/user/campaigns/performance",
  analyticsController.getUserCampaignPerformance
);
